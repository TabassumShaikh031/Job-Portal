  ...
  return (
    <>
      ...
      <div className='container px-4 min-h-[65vh] 2xl:px-20 mx-auto my-10'>
        ...
        <div className='flex gap-2 mb-6 mt-3'>
          {
            isEdit ? <>
              <label className='flex items-center' htmlFor="resumeUpload">
                <p className='bg-blue-100 text-blue-600 px-4 py-2 rounded-1g mr-2'>Select Resume</p>
                <input id="resumeUpload" onChange={e => setResume(e.target.files[0])} accept="application/pdf" type="file" hidden />
                <img src={assets.profile_upload_icon} alt="" />
              </label>
              <button onClick={e => setIsEdit(false)} className='bg-green-100 border border-gren-400 rounded-lg px-4 py-2'>Save</button>
        ...
        <table className='min-w-full bg-white border border-gray-200 rounded-1g'>
          <thead>
            <tr>
