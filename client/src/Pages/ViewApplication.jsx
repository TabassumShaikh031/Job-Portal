        ...
        <table className='w-full max-w-4xl bg-white border border-gray-200 text-sm'>
          <thead>
            <tr className='border-b border-gray-200'>
              ...
              <th className='py-2 px-4 text-left max-sm:hiden' >Job Title</th>
              <th className='py-2 px-4 text-left max-sm:hiden' >Location</th>
            ...
            {viewApplicationsPageData.map((applicant, index) => (
              <tr key={index} className='text-gray-700'>
                ...
                <td className='py-2 px-4 border-b border-gray-200 '>
                  <a className='bg-blue-50 text-blue-400 px-3 py-1 rounded inline-flex gap-2 items-center' href="" target='_blank'>Resume
